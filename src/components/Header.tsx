...
import { MessageCircle, BookOpen, Heart, Menu, X, Globe, User, Bell } from 'lucide-react';
...
const Header: React.FC<HeaderProps> = ({ 
  ...
  const navItems = [
    ...
    { id: 'career', label: 'Career Paths', icon: BookOpen },
          ...
          <div className="hidden md:flex items-center space-x-4">
            {userProfile.name && (
              <div className="flex items-center space-x-2 bg-blue-50 px-3 py-1 rounded-lg">
                ...
                <span className="text-sm font-medium text-blue-700">{userProfile.name}</span>
              </div>
            )}
